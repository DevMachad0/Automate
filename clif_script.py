...
def open_link(login, senha, datainicio, datafim, time_interval, armazem_index):
    ...
    try:
        ...
        while True:  # Loop infinito
            print("NOVO LOOP")
            driver.get("https://sesce.clif.rvimola.com.br/Relsaidasgerals/filtrosaidas_sintetico")
            time.sleep(10)  # Espera a página carregar

            # Seleciona o armazém pelo índice
            select_armazem = Select(driver.find_element(By.XPATH, '//*[@id="cod_wms"]'))
            ...
            filename = os.path.join(arquivo_data, 'relatorio_saidas_geral_sintetico_col.xlsx')  # Ajuste o nome e extensão conforme necessário
